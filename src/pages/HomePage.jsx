          ...
          <Card className="mt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center p-3 bg-blue-50 rounded-lg">
                <div className="text-lg font-bold text-blue-600 break-all max-w-full font-mono text-xs">{geoData.ip}</div>
                <div className="text-sm text-gray-500 mt-1">IP Address</div>
              </div>
              <div className="text-center p-3 bg-green-50 rounded-lg">
                <div className="text-2xl font-bold text-green-600">{geoData.city || 'Unknown'}</div>
                <div className="text-sm text-gray-500">City</div>
              </div>
              <div className="text-center p-3 bg-purple-50 rounded-lg">
                <div className="text-2xl font-bold text-purple-600">{geoData.country || 'Unknown'}</div>
                <div className="text-sm text-gray-500">Country</div>
              </div>
              <div className="text-center p-3 bg-orange-50 rounded-lg">
                <div className="text-2xl font-bold text-orange-600">{geoData.org?.split(' ')[0] || 'Unknown'}</div>
